...
$_['text_guest']    = '<p>Зарегистрированным пользователям доступен просмотр состояния заказа и прошлых покупок.</p><p>Спасибо за покупки в нашем интернет-магазине!</p>';
$_['text_customer'] = '<p>Вы можете просматривать историю заказов в Личном кабинете</p>Спасибо за покупки в нашем интернет-магазине!</p>';
