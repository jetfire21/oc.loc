...
class ControllerInformationNews extends Controller {
	...
	public function index() {
		...
		$all_news_short = $this->model_catalog_news->getNewsShorts($limit = 10);
		
		foreach( $all_news_short as $k => $v){
			$all_news_short[$k]['href'] = $this->url->link('information/news', 'news_id=' . $v['news_id']);
		}

		$this->data['all_news_short'] = $all_news_short;
