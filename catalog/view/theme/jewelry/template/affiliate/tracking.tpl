			...
			<div class="cart-product">
				...
				<div class="wrap_table">
					<div class="ref-text">
						...
						<p>
						Система многоуровневая - поэтому вы будете получать деньги и в пасивном режиме, если знакомые начнут давать свои ссылки своим знакомым. Выводите деньги на свою карту в любое время! Подробнее <a href="/index.php?route=information/information&information_id=8" class="pink"> о партенрской программе</a></p>
					</div>
					<div class="my-link">
						<h4>Моя ссылка:</h4>
