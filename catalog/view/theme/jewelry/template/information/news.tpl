			...
			<div class="container">
				<div class="page-content">
			   	  <div class="page-left">
				   	    ...
				   	    <div class="inner-pl">
					   	  	<?php foreach($all_news_short as $item) { ?>
			   	  ...
			   	  <?php if($news_info) { ?>
					  <div class="article">
				  		 <img src="<?php echo $base."image/".$news_info['full_img'];?>" alt="">
				  		 <!-- <img src="catalog/view/theme/<?php echo $this->config->get('config_template');?>/images/article-big-img.jpg" alt=""> -->
				  		 <div class="a-text">
					  	    <h2><a href="">// <?php echo $news_info['title'];?> </a></h2>
				  		    <span><?php echo $news_info['author'];?></span>
				  		 </div>
				  	 </div>	
