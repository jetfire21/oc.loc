...
class ModelCatalogNews extends Model {
	...
	public function addNews($data) {
		...
		if (isset($data['full_img'])) {
			$this->db->query("UPDATE " . DB_PREFIX . "news SET full_img = '" . $this->db->escape($data['full_img']) . "' WHERE news_id = '" . (int)$news_id . "'");
		}
		...
		foreach ($data['news_description'] as $language_id => $value) {
			$this->db->query("INSERT INTO " . DB_PREFIX . "news_description SET news_id = '" . (int)$news_id . "', language_id = '" . (int)$language_id . "', title = '" . $this->db->escape($value['title']) . "', meta_description = '" . $this->db->escape($value['meta_description']) . "', meta_keyword = '" . $this->db->escape($value['meta_keyword']) . "' , author = '" . $this->db->escape($value['author']) . "' , quote = '" . $this->db->escape($value['quote']) . "' , quote_author = '" . $this->db->escape($value['quote_author']) . "', description = '" . $this->db->escape($value['description']) . "'");
		}
