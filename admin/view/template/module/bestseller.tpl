          ...
          <tbody id="module-row<?php echo $module_row; ?>">
            <tr>
              ...
              <td class="left"><select name="bestseller_module[<?php echo $module_row; ?>][position]">
                  ...
                  <?php if ($module['position'] == 'topsell_bottom') { ?>
                  <option value="topsell_bottom" selected="selected">Топ продаж-низ</option>
                  <?php } else { ?>
                  <option value="topsell_bottom">Топ продаж-низ</option>
                  <?php } ?>
...
function addModule() {	
  ...
  html += '      <option value="content_top"><?php echo $text_content_top; ?></option>';
	html += '      <option value="topsell_bottom">Топ продаж-низ</option>';
