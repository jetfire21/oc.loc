    ...
    <div class="content">
        ...
        <div id="tab_language">
			...
			<div id="language<?php echo $language['language_id']; ?>">
				...
				<tr>
					...
					<td><input name="news_description[<?php echo $language['language_id']; ?>][author]" size="80" value="<?php echo isset($news_description[$language['language_id']]) ? $news_description[$language['language_id']]['author'] : ''; ?>" />
					</td>
				</tr>
				<tr>
				...
				<tr>
					...
					<td><textarea name="news_description[<?php echo $language['language_id']; ?>][quote]" cols="70" rows="2"><?php echo isset($news_description[$language['language_id']]) ? $news_description[$language['language_id']]['quote'] : ''; ?></textarea></td>
				</tr>				
				<tr>
					<td><?php echo $entry_quote_author; ?></td>
					<td><input name="news_description[<?php echo $language['language_id']; ?>][quote_author]" size="80" value="<?php echo isset($news_description[$language['language_id']]) ? $news_description[$language['language_id']]['quote_author'] : ''; ?>" />
					</td>
				</tr>
            <tr>
        ...
        <div id="tab_setting">
            ...
            <tr>
             ...
             <tr>
				<td><?php echo $entry_full_img; ?></td>
				<td><div class="image"><img src="<?php echo $full_img; ?>" alt="" id="big_img" /><br />
					<input type="hidden" name="full_img" value="<?php echo $full_img; ?>" id="image2" />
					<a onclick="image_upload('image2', 'big_img');"><?php echo $text_browse; ?></a>&nbsp;&nbsp;|&nbsp;&nbsp;<a onclick="$('#big_img').attr('src', '<?php echo $no_image; ?>'); $('#image2').attr('value', '');"><?php echo $text_clear; ?></a></div>
				</td>
            </tr>
