		...
		<form action="<?php echo $action; ?>" method="post" enctype="multipart/form-data" id="form" name="newsform">
            ...
            <tbody id="module-row<?php echo $module_row; ?>">
                ...
                <td class="left">
                 ...
                 <?php if ($module['position'] == 'articleprod_bottom') { ?>

                  <option value="articleprod_bottom" selected="selected">Продукт-низ-перед-футером</option>

                  <?php } else { ?>

                  <option value="articleprod_bottom">Продукт-низ-перед-футером</option>
...
function addModule() {	
	...
	html += '      	<option value="content_top"><?php echo $text_content_top; ?></option>';
		html += '      <option value="articleprod_bottom">Продукт-низ-перед-футером</option>';
