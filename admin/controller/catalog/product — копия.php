...
class ControllerCatalogProduct extends Controller {
	...
	public function filter() {
  	...
  	protected function getForm() {
		...
		$this->data['entry_color_met'] = $this->language->get('entry_color_met');
    	...
    	if (isset($this->request->post['opt_price'])) {
      		$this->data['opt_price'] = $this->request->post['opt_price'];
    	} elseif (!empty($product_info)) {
			$this->data['opt_price'] = $product_info['opt_price'];
		} else {
      		$this->data['opt_price'] = '';
    	}  
      	...
      	if (isset($this->request->post['hot'])) {
			...
			$this->data['hot'] = $product_info['hot'];
		} else {
      		$this->data['hot'] = false;
    	}


      	if (isset($this->request->post['top_akses'])) {
      		$this->data['top_akses'] = $this->request->post['top_akses'];
    	} elseif (!empty($product_info)) {
			$this->data['top_akses'] = $product_info['top_akses'];
		} else {
      		$this->data['top_akses'] = false;
    	}


    	if (isset($this->request->post['price_zakup'])) {
      		$this->data['price_zakup'] = $this->request->post['price_zakup'];
    	} elseif (!empty($product_info)) {
			$this->data['price_zakup'] = $product_info['price_zakup'];
		} else {
      		$this->data['price_zakup'] = '';
    	}
