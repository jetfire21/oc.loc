...
class ControllerModuleNews extends Controller {
	...
	private function getForm() { 
		...
		$this->data['entry_quote_author'] = $this->language->get('entry_quote_author');
		$this->data['entry_description'] = $this->language->get('entry_description');
		$this->data['entry_store'] = $this->language->get('entry_store');
		$this->data['entry_keyword'] = $this->language->get('entry_keyword');
		$this->data['entry_image'] = $this->language->get('entry_image');
		$this->data['entry_full_img'] = $this->language->get('entry_full_img');
		$this->data['entry_status'] = $this->language->get('entry_status');
		...
		if (isset($this->request->post['full_img'])) {
			$this->data['full_img'] = $this->request->post['full_img'];
		} elseif (!empty($news_info)) {
			$this->data['full_img'] = $news_info['full_img'];
		} else {
			$this->data['full_img'] = '';
		}
		...
		if (isset($this->request->post['full_img']) && file_exists(DIR_IMAGE . $this->request->post['full_img'])) {
			$this->data['full_img'] = $this->model_tool_image->resize($this->request->post['full_img'], 100, 100);
		} elseif (!empty($news_info) && $news_info['full_img'] && file_exists(DIR_IMAGE . $news_info['full_img'])) {
			$this->data['full_img'] = $this->model_tool_image->resize($news_info['full_img'], 100, 100);
		} else {
			$this->data['full_img'] = $this->model_tool_image->resize('no_image.jpg', 100, 100);
		}
