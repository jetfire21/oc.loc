      ...
      <form action="<?php echo $action; ?>" method="post" enctype="multipart/form-data" id="form">
        <div id="tab-general">
          ...
          <div id="language<?php echo $language['language_id']; ?>">
            <table class="form">
              ...
              <tr>
              <tr>
                <td><?php echo $entry_color_met; ?></td>
                <td><input type="text" name="product_description[<?php echo $language['language_id']; ?>][color_met]" maxlength="255" size="100" value="<?php echo isset($product_description[$language['language_id']]) ? $product_description[$language['language_id']]['color_met'] : ''; ?>" /></td>
              </tr>
        ...
        <div id="tab-data">
          <table class="form">
            ...
            <tr>
             <td> Горячие товары:</td>
               <td>
                  <?php if(!empty($hot)) { ?>
                   <input type="checkbox" name="hot" value="1" checked="checked" onclick="if( $(this).val() == 1){ $(this).attr('value','2') } else { $(this).attr('value','1') };"/>
                  <?php } else { ?>
                      <input type="checkbox" name="hot" value="0" onclick="if( $(this).val() == 1){ $(this).attr('value','0') } else { $(this).attr('value','1') };"/>
                  <?php } ?>
               </td>
            </tr>   

            <tr>
             <td> Популярные аксессуары: <?php print_r($products);?></td>
               <td>
                  <?php if(!empty($top_akses)) { ?>
                   <input type="checkbox" name="top_akses" value="1" checked="checked" onclick="if( $(this).val() == 1){ $(this).attr('value','2') } else { $(this).attr('value','1') };"/>
                  <?php } else { ?>
                      <input type="checkbox" name="top_akses" value="0" onclick="if( $(this).val() == 1){ $(this).attr('value','0') } else { $(this).attr('value','1') };"/>
                  <?php } ?>
               </td>
            </tr>
			...
			<?php } ?>
              ...
              <td><?php echo $entry_opt_price; ?></td>
              <td><input type="text" name="opt_price" value="<?php echo $opt_price; ?>" /></td>
            </tr>   
           <tr>
              <td><?php echo $entry_price_zakup; ?></td>
              <td><input type="text" name="price_zakup" value="<?php echo $price_zakup; ?>" /></td>
            </tr>
            <tr>
